...
- (void)scrollViewCanScroll:(BOOL)canScroll {
    scrollView.scrollEnabled = canScroll;
}

- (void)startRolling
{
    if (self.imagesArray == nil || self.imagesArray.count <= 1)
    {
        return;
    }
